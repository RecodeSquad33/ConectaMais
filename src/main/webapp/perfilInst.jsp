	...
	<main class="container">
		...
		<div class="row mb-5">
			<div class="col-lg-4 com-sm-12 mb-3 mt-5" style="text-align: center;">
				<a href="/ConectaMais/criarEventos" type="submit"
					class="btn btn-primary col-6" id="login">Criar um Evento</a>
			</div>
			<div class="col-lg-6 com-sm-12" style="text-align: center;">
				<button type="submit" class="btn btn-primary col-6" id="login">Logar</button>
			</div>
			<div class="col-lg-6 col-sm-12" style="text-align: center;">
				<a href="index.html"><button type="button" id="senha"
						class="btn btn-danger col-6">Sair</button></a>
			</div>
		</div>
	</main>
